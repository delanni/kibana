...
export async function pickTestGroupRunOrder() {
  ...
  // We didn't backport the sharding here
  let jestUnitConfigs = jestUnitConfigsFiltered;
  ...
  const jestIntegrationConfigs = LIMIT_CONFIG_TYPE.includes('integration')
    ...
    : [];
  // We didn't backport sharding here
  let jestIntegrationConfigs = jestIntegrationConfigsRaw;
